  ...
  return (
    ...
    <Box  sx={{ width: '100%' }}>
      ...
      <Box sx={{  borderColor: 'divider' }}>
        ...
        aria-label="scrollable force tabs example"  className={styles.tab}  >
          <Tab label= "Makkah " className={styles.tabhead} {...a11yProps(0)} />
          <Tab label="Jab e Nor" className={styles.tabhead} {...a11yProps(1)} />
          <Tab label="Taif" className={styles.tabhead} {...a11yProps(2)} />
          <Tab label="Gare Hirea" className={styles.tabhead} {...a11yProps(3)} />
          <Tab label="Gare Sor" className={styles.tabhead} {...a11yProps(4)} />
          <Tab label="Maidan" className={styles.tabhead} {...a11yProps(5)} />
          <Tab label="Khyber" className={styles.tabhead} {...a11yProps(6)} />
          <Tab label="Wadi e jin" className={styles.tabhead} {...a11yProps(7)} />
...
<Box className={styles.text} >
 We are here to be your dependable Makkah Taxi Service. We make sure you get where you need to go safely and smoothly. Whether you're going from Makkah to Madinah or just around Makkah, even to Masjid Ayesha Miqat, we're here for you. Our cars are well taken care of and come in different types to fit what you need. Our skilled drivers know the way between Makkah and Madinah and make sure you reach your stop on time and comfortably. Our prices to go from Makkah to Madinah are fair and clear. Safety is really important to us: our cars have GPS trackers and our drivers are checked out before they start driving. You can easily book your Makkah Taxi Service on our website, by phone, or with our app. Thanks for picking Harmain Taxi to get around Makkah!
      ...
      <Grid item xs={12} sm={6} md={6} lg={4}>
            ...
            <br />
            <br />
          <Image src={img1}  className={styles.img} alt='img' />
          </Grid>
          <Grid item xs={12} sm={6} md={6} lg={8}>
<Box className={styles.header} >
Jab e nor
...
We're happy that we're always on time, have friendly customer service, and offer good prices.
     ...
     <TabPanel value={value} index={2}>
      ...
      <Grid item xs={12} sm={6} md={6} lg={4}>
            ...
            <br />
            <br />
          <Image src={img2}  className={styles.img} alt='img' />
          </Grid>
          <Grid item xs={12} sm={6} md={6} lg={8}>
<Box className={styles.header} >
  Taif
...
<br />
<Box className={styles.text} >
Welcome to Usman Taxi, your go-to provider for Gar e Hira taxi services. Our company is dedicated to providing safe, reliable and efficient transportation to all of our customers. We offer a wide range of services including airport transfers, corporate transportation, and sightseeing tours. Our fleet of vehicles is well-maintained and features a variety of options to suit your needs, including sedans, SUVs, and minivans. Our team of experienced drivers are familiar with the Gar e Hira area and will ensure that you arrive at your destination on time and in comfort. Safety is our top priority, all vehicles are equipped with GPS tracking and our drivers go through thorough background checks. Book a taxi with us easily through our website, by call or mobile app. Thanks for choosing Harmain Taxi for your transportation needs in Gar e Hira.
</Box>
...
<br />
<Box className={styles.text} >
Welcome to Usman Taxi, the top choice for Gar e Sor taxi services. Our main goal is to provide you with secure, dependable, and effective transportation. Our services cover a wide spectrum, including airport transfers, corporate travel, and sightseeing tours. Our fleet of vehicles is meticulously maintained and offers various options like sedans, SUVs, and minivans to suit your preferences. Our skilled drivers are familiar with the Gar e Sor area and will make sure you reach your destination on time and in comfort.

Safety is our utmost priority. All our vehicles are equipped with GPS tracking, and our drivers undergo comprehensive background checks. Booking a taxi with us is simple – you can do it through our website, by phone, or using our mobile app. We appreciate you choosing Harmain Taxi for your transportation needs in Gar e Sor.
</Box>
...
Similarly, Umrah taxi prices also change based on how far you're traveling, the size of the vehicle, and how comfortable it is. It's a good practice to research and compare prices from different companies before making a choice.
      ...
      <Grid item xs={12} sm={6} md={6} lg={4}>
            ...
            <br />
            <br />
          <Image src={img6}  className={styles.img} alt='img' />
          </Grid>
          <Grid item xs={12} sm={6} md={6} lg={8}>
<Box className={styles.header} >
Khyber
...
Hajj taxi prices can differ based on factors like the distance traveled, the size of the vehicle, and the comfort level it provides. It's essential to research and compare prices from various companies before making your decision.
      ...
      <Grid item xs={12} sm={6} md={6} lg={4}>
            ...
            <br />
            <br />
          <Image src={img7}  className={styles.img} alt='img' />
          </Grid>
          <Grid item xs={12} sm={6} md={6} lg={8}>
<Box className={styles.header} >
Wadi e jin
